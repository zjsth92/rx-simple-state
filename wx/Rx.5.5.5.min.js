var window={Object,setTimeout,clearTimeout};window.window = window;/*add for wx*/var $jscomp={scope:{}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(l,k,x){if(x.get||x.set)throw new TypeError("ES3 does not support getters and setters.");l!=Array.prototype&&l!=Object.prototype&&(l[k]=x.value)};$jscomp.getGlobal=function(l){return"undefined"!=typeof window&&window===l?l:"undefined"!=typeof global&&null!=global?global:l};$jscomp.global=$jscomp.getGlobal(this);
...
a.length;){var d=a.shift();0<d.length&&e.next(d)}b.prototype._complete.call(this)};return a}(m);g.prototype.bufferCount=function(b,a){void 0===a&&(a=null);return Va(b,a)(this)};var Dd=function(){function b(a,c,b,d){this.bufferTimeSpan=a;this.bufferCreationInterval=c;this.maxBufferSize=b;this.scheduler=d}b.prototype.call=function(a,c){return c.subscribe(new Sf(a,this.bufferTimeSpan,this.bufferCreationInterval,this.maxBufferSize,this.scheduler))};return b}(),Tf=function(){return function(){this.buffer=
[]}}(),Sf=function(b){function a(a,e,d,f,h){b.call(this,a);this.bufferTimeSpan=e;this.bufferCreationInterval=d;this.maxBufferSize=f;this.scheduler=h;this.contexts=[];a=this.openContext();(this.timespanOnly=null==d||0>d)?this.add(a.closeAction=h.schedule(Xa,e,{subscriber:this,context:a,bufferTimeSpan:e})):(f={bufferTimeSpan:e,bufferCreationInterval:d,subscriber:this,scheduler:h},this.add(a.closeAction=h.schedule(Ya,e,{subscriber:this,context:a})),this.add(h.schedule(Ed,d,f)))}k(a,b);a.prototype._next=
...
this.hasSubscription||this.destination.complete()};a.prototype.notifyComplete=function(a){this.remove(a);this.hasSubscription=!1;this.hasCompleted&&this.destination.complete()};return a}(t);g.prototype.exhaust=function(){return qb()(this)};var Vd=function(){function b(a,c){this.project=a;this.resultSelector=c}b.prototype.call=function(a,c){return c.subscribe(new kg(a,this.project,this.resultSelector))};return b}(),kg=function(b){function a(a,e,d){b.call(this,a);this.project=e;this.resultSelector=
...
a.prototype.notifyComplete=function(a){var c=this.buffer;this.remove(a);this.active--;c&&0<c.length&&this._next(c.shift());this.hasCompleted&&0===this.active&&this.destination.complete()};return a}(t);g.prototype.expand=function(b,a,c){void 0===a&&(a=Number.POSITIVE_INFINITY);void 0===c&&(c=void 0);a=1>(a||0)?Number.POSITIVE_INFINITY:a;return sb(b,a,c)(this)};var Q=function(b){function a(){var a=b.call(this,"argument out of range");this.name=a.name="ArgumentOutOfRangeError";this.stack=a.stack;this.message=
...
c){return c.subscribe(new Dg(a))};return b}(),Dg=function(b){function a(a){b.call(this,a)}k(a,b);a.prototype._next=function(a){this.destination.next(y.createNext(a))};a.prototype._error=function(a){var c=this.destination;c.next(y.createError(a));c.complete()};a.prototype._complete=function(){var a=this.destination;a.next(y.createComplete());a.complete()};return a}(m);g.prototype.materialize=function(){return Jb()(this)};var ie=function(){function b(a,c,b){void 0===b&&(b=!1);this.accumulator=a;this.seed=
